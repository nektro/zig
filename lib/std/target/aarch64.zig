...
pub const all_features = blk: {
    ...
    result[@enumToInt(Feature.a715)] = .{
        .llvm_name = "a715",
        .description = "Cortex-A715 ARM processors",
        .dependencies = featureSet(&[_]Feature{
            .cmp_bcc_fusion,
            .enable_select_opt,
            .fuse_adrp_add,
    ...
    result[@enumToInt(Feature.apple_a15)] = .{
        .llvm_name = "apple-a15",
    ...
    result[@enumToInt(Feature.apple_a16)] = .{
        .llvm_name = "apple-a16",
        .description = "Apple A16",
        .dependencies = featureSet(&[_]Feature{
            .alternate_sextload_cvt_f32_pattern,
            .arith_bcc_fusion,
            .arith_cbz_fusion,
    ...
    result[@enumToInt(Feature.cortex_x3)] = .{
        .llvm_name = "cortex-x3",
        .description = "Cortex-X3 ARM processors",
        .dependencies = featureSet(&[_]Feature{
            .enable_select_opt,
            .fuse_adrp_add,
            .fuse_aes,
    ...
    result[@enumToInt(Feature.neoversev2)] = .{
        .llvm_name = "neoversev2",
        .description = "Neoverse V2 ARM processors",
        .dependencies = featureSet(&[_]Feature{
            .enable_select_opt,
            .fuse_aes,
            .lsl_fast,
